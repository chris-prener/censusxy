...
Be cautious that batches taking a long time may allow your computer to sleep, which may cause a batch to never return. macOS users may find the app [caffeine](http://lightheadsw.com/caffeine/) useful (Also available as a Command Line Tool).
...
* If you think you've found a bug, please create a [`reprex`](http://reprex.tidyverse.org/) and then open an issue on [GitHub](https://github.com/slu-openGIS/censusxy/issues/new/choose).
