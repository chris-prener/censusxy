...
We will update the package documentation again if this issue persists beyond macOS v12.4 and/or the next release of `R` (which includes the `parallel` package).
